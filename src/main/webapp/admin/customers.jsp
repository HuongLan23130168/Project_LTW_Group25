    ...
    <div class="customers-header">
        ...
        <div class="filter-container">
            <select id="filterTime">
                ...
                <option selected>10 ngày gần nhất</option>
    ...
    <div class="table-container">
        <table class="customers-table">
            ...
            <tr>
                ...
                <td>quamon@gmail.com</td>
                <td>09013234567</td>
                <td>5 đơn</td>
                <td><a href="customerDetail.jsp" class="view-btn">Xem</a></td>
            </tr>
            <tr>
                <td>Trần Công An</td>
                <td>congan@gmail.com</td>
                <td>09124345678</td>
                <td>8 đơn</td>
                <td><a href="customerDetail.jsp" class="view-btn">Xem</a></td>
            </tr>
            ...
            <tr>
                <td>Nguyễn Thành Thân</td>
                <td>kethon@gmail.com</td>
                <td>00022994472</td>
                <td>1 đơn</td>
                <td><a href="customerDetail.jsp" class="view-btn">Xem</a></td>
            </tr>
            ...
            <tr>
                <td>Huỳnh Hoành Hùng</td>
                <td>hunghung@gmail.com</td>
                <td>0987611321</td>
                <td>1 đơn</td>
                <td><a href="customerDetail.jsp" class="view-btn">Xem</a></td>
            </tr>
            ...
            <tr>
                <td>Trần Thị Quýt Hàng</td>
                <td>quyt@gmail.com</td>
                <td>0000001292</td>
                <td>2 đơn</td>
                <td><a href="customerDetail.jsp" class="view-btn">Xem</a></td>
            </tr>
